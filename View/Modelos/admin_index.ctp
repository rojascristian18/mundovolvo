		...
		<div class="panel-body">
			<div class="table-responsive">
				<table class="table">
					<thead>
						<tr class="sort">
							<th><?= $this->Paginator->sort('categoria_modelo_id', null, array('title' => 'Haz click para ordenar por este criterio')); ?></th>
					...
					<tbody>
						...
						<tr>
							<td><?= $this->Html->link($modelo['CategoriaModelo']['nombre'], array('controller' => 'categoria_modelos', 'action' => 'edit', $modelo['CategoriaModelo']['id'])); ?></td>
							<td><?= $this->Html->link($modelo['Marca']['nombre'], array('controller' => 'marcas', 'action' => 'edit', $modelo['Marca']['id'])); ?></td>
							<td><?= h($modelo['Modelo']['nombre']); ?>&nbsp;</td>
							<td><?= h($modelo['Modelo']['nombre_corto']); ?>&nbsp;</td>
							<td><?= h($modelo['Modelo']['titulo']); ?>&nbsp;</td>
							<td>
